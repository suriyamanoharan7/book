...
def create_book_service(request,db,publisher):
    new_book = Book(
        title = request.title,
...
def book_get_id(db:Session,book_id):
...
def book_update_service(db:Session,book_id,request,publisher):
    ...
    if update:
        ...
        update.publisher_id = publisher.id
...
def book_delete_service(db:Session,book_id):
